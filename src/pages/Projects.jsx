  ...
  const projects = [
    {
      ...
      subProjects: [
        { title: 'KNSB Sugar Propellant Motor', desc: 'Conducted comprehensive research and practical testing on KNSB solid propellants, aiming to create a reliable, castable motor for student rocketry.', img: getProjectImg('p2') },
        { title: 'Static Test Stand & DAQ', desc: 'Designed a static test stand using load cells and custom DAQ to measure thrust curves and characterize motor profiles.', img: getProjectImg('p3') },
        { title: 'Modular Phenolic Casings', desc: '[Placeholder] - Investigating the use of modular phenolic casings for reusable student rocketry applications.', img: getProjectImg('p1') }
      ]
    },
    {
      id: 2,
      ...
      subProjects: [
        { title: 'Grid Fins as High Lift Devices', desc: 'Utilized ANSYS Fluent to run 3D steady-state CFD simulations over varying angles of attack, comparing lift and drag coefficients against traditional planar fins.', img: getProjectImg('p4') },
        { title: 'Poly-Hexcore Mesh Optimization', desc: 'Implemented targeted mesh refinement strategies and employed the k-omega SST turbulence model to balance accuracy.', img: getProjectImg('p1') },
        { title: 'Wind Tunnel Validation', desc: '[Placeholder] - Future physical wind tunnel testing to validate the CFD aerodynamic stall characteristics.', img: getProjectImg('p2') }
      ]
    },
    {
      id: 3,
      ...
      subProjects: [
        { title: 'NASA USLI Launch Vehicle', desc: 'Served as Chief Engineer overseeing the full lifecycle from conceptual design to launch and recovery.', img: getProjectImg('p5') },
        { title: 'Spaceport America Cup Payload', desc: 'Organized sub-team workflows and established rigorous systems engineering design reviews.', img: getProjectImg('p6') },
        { title: 'Avionics Bulkhead Redesign', desc: 'Redesigned the coupling system using FEA to identify stress concentrations, shifting to a custom-machined aluminum bulkhead.', img: getProjectImg('p3') }
      ]
    }
  ];
